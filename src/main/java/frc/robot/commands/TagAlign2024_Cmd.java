...
public class TagAlign2024_Cmd extends Command {
  ...
  private LimeLight_Subsystem limeLightSubsystem;
  private Swerve_Subsystem drivetrain;

  public TagAlign2024_Cmd(LimeLight_Subsystem limeLightSubsystem, Swerve_Subsystem drivetrain) {
  ...
  public void execute() {
    ...
    if (!limeLightSubsystem.getHasTargets()){
