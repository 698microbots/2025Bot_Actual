...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(110).withKI(0).withKD(0.5) // ORIGINAL: 100,0,.5
        .withKS(0).withKV(0).withKA(0) // ORIGINAL: .1, 1.59, 0
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(3).withKI(0).withKD(0) // ORIGINAL: .1, 0, 0
        .withKS(0).withKV(0); // ORIGINAL: 0, .124
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(3.2);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.235595703125);
     ...
     */
    public static Swerve_Subsystem createDrivetrain() {
        return new Swerve_Subsystem(
